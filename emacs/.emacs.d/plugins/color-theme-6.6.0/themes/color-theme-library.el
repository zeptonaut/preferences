...
(defun color-theme-vim-colors ()
  ...
  (color-theme-install
   '(color-theme-vim-colors
     ...
     (font-lock-comment-face ((t (:foreground "blue" :background "#f2f2f2" :italic t))))
     (font-lock-doc-face ((t (:foreground "blue" :background "#f2f2f2" :italic t))))
     ...
     (font-lock-string-face ((t (:background "#f2f2f2" :foreground "#e05600"))))
     (font-lock-type-face ((t (:foreground "ForestGreen" :bold (bold extra-bold ultra-bold)))))
     (font-lock-variable-name-face ((t (:foreground "#6600BA"))))

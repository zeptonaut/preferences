...
(custom-set-variables
 ...
 '(org-capture-templates (quote (("t" "todo" entry (file+headline "~/Dropbox/org/todo.org" "Inbox") "* TODO %?
...
"))))
 ...
 '(safe-local-variable-values (quote ((flycheck-mode t) (company-mode t) (ycmd-mode t) (irony-mode) (c++-mode (c-file-style . "WebKit")) (c-mode (c-file-style . "WebKit"))))))
(custom-set-faces
